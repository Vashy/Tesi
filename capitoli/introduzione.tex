...
Sync Lab ha come punti di forza la qualità dei servizi offerti (certificazioni \acrshort{iso} 9001,
...
paradigmi tecnologici e di comunicazione, ad esempio \gls{big-data}, \textit{Cloud Computing},
\gls{iot}, \textit{Mobile e Sicurezza \acrshort{it}}, per supportare i propri clienti nella creazione
