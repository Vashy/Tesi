...
\begin{itemize}
	...
	\item il \textit{back-end} utilizzerà un'architettura a \glsdisp{microservizio}{microservizi} implementati con il \textit{framework} \gls{spring}\gloss (\gls{java}\gloss), come requisito di vincolo, con \gls{mongodb}\gloss\ come \gls{dbms}\gloss.
\end{itemize}

Nello svolgere tale progetto saranno presenti altri stagisti oltre al sottoscritto, a ciascuno dei quali sarà assegnato un equo carico di lavoro.
...
Il mio ruolo nel progetto consiste prettamente nell'implementazione di alcuni \glsdisp{microservizio}{microservizi} back-end e nel riadattamento del vecchio portale.
