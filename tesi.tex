...
\input{capitoli/stage}                  % Kick-Off
\input{capitoli/requisiti}              % Concept Preview
\input{capitoli/progettazione}          % Product Prototype
\input{capitoli/verifica}               % Product Design Freeze e SOP
\input{capitoli/conclusioni}            % Conclusioni
\appendix
\input{capitoli/appendice-A}            % Appendice A
