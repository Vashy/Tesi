...
%	 capitoli/requisiti,
%	  capitoli/progettazione
%	capitoli/conclusioni
%  }
...
\include{capitoli/stage}                  % Kick-Off
\include{capitoli/requisiti}              % Concept Preview
\include{capitoli/progettazione}          % Product Prototype
%\include{capitoli/verifica}               % Product Design Freeze e SOP
\include{capitoli/conclusioni}            % Conclusioni
\appendix
\include{capitoli/microservizi}            % Appendice A
\include{capitoli/spring-cloud}
